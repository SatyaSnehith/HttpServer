...
/* harmony export */ });
/* harmony import */ var _element_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./element */ "./src/element.js");
/* harmony import */ var _style_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./style */ "./src/style.js");
/* harmony import */ var _ref_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./ref */ "./src/ref.js");
...
var HorizontalSpace = /*#__PURE__*/function (_Element) {
  ...
  _inherits(HorizontalSpace, _Element);
  return _createClass(HorizontalSpace);
}(_element_js__WEBPACK_IMPORTED_MODULE_0__.Element);
var VerticalSpace = /*#__PURE__*/function (_Element2) {
  ...
  _inherits(VerticalSpace, _Element2);
  ...
  function HorizontalDivider(props) {
    ...
    return _callSuper(this, HorizontalDivider, [{
      ...
      styles: _objectSpread({
        height: '1px',
        backgroundColor: _style_js__WEBPACK_IMPORTED_MODULE_1__.Color.BorderColor
      }, props.styles)
    }]);
  }
...
var Row = /*#__PURE__*/function (_Element4) {
  ...
  function Row(props) {
    ...
    _this2.style(_style_js__WEBPACK_IMPORTED_MODULE_1__.Style.Row);
...
var Column = /*#__PURE__*/function (_Element5) {
  ...
  function Column(props) {
    ...
    _this3.style(_style_js__WEBPACK_IMPORTED_MODULE_1__.Style.Column);
  ...
  function Text(props) {
    ...
    _this4 = _callSuper(this, Text, [{
      ...
      styles: _objectSpread(_objectSpread({}, {
        margin: '0px',
        color: _style_js__WEBPACK_IMPORTED_MODULE_1__.Color.TextColor
      }), props.styles)
    }]);
...
var SvgIcon = /*#__PURE__*/function (_Element7) {
  ...
  function SvgIcon(props) {
    ...
    _this5.node = (0,_element_js__WEBPACK_IMPORTED_MODULE_0__.fromHTML)(_style_js__WEBPACK_IMPORTED_MODULE_1__.Icon.icons[props.svgName]);
    _this5.style(_objectSpread(_objectSpread(_objectSpread({}, _style_js__WEBPACK_IMPORTED_MODULE_1__.Style.Size(_this5.size)), props.styles), {}, {
      stoke: _style_js__WEBPACK_IMPORTED_MODULE_1__.Color.TextColor
    }, _style_js__WEBPACK_IMPORTED_MODULE_1__.Style.Size(_this5.size)));
  ...
  return _createClass(SvgIcon, [{
    ...
    value: function content(props) {
      ...
      this.style(_objectSpread(_objectSpread(_objectSpread({}, props.styles), {}, {
        ...
        // svg bug
        pointerEvents: 'none'
      }, _style_js__WEBPACK_IMPORTED_MODULE_1__.Style.Size(this.size)), {}, {
        stoke: _style_js__WEBPACK_IMPORTED_MODULE_1__.Color.TextColor
      }));
    }
  }]);
...
var IconButton = /*#__PURE__*/function (_Element8) {
  ...
  function IconButton(props) {
    ...
    _this6.style(_objectSpread({
      ...
      padding: '8px',
      borderRadius: '6px'
    }, _style_js__WEBPACK_IMPORTED_MODULE_1__.Style.Pointer));
    _this6.svg = new SvgIcon({
      svgName: props.svgName,
      size: '16px'
    });
    _this6.add(_this6.svg);
    _this6.hoverStyle(_style_js__WEBPACK_IMPORTED_MODULE_1__.Style.EmptyBg, _style_js__WEBPACK_IMPORTED_MODULE_1__.Style.CardBg);
    return _this6;
  }
...
var Button = /*#__PURE__*/function (_Element9) {
  ...
  function Button(props) {
    ...
    _this7.hoverStyle(_style_js__WEBPACK_IMPORTED_MODULE_1__.Style.EmptyBg, _style_js__WEBPACK_IMPORTED_MODULE_1__.Style.CardBg);
    _this7.style({
      margin: '0px',
      color: _style_js__WEBPACK_IMPORTED_MODULE_1__.Color.TextColor
    }, _style_js__WEBPACK_IMPORTED_MODULE_1__.Style.BorderRadius('4px'), _style_js__WEBPACK_IMPORTED_MODULE_1__.Style.Padding('4px 8px'), _style_js__WEBPACK_IMPORTED_MODULE_1__.Style.Pointer);
    if (props.svgName) {
      _this7.style({
        display: 'flex',
        flexDirection: 'row',
...
var Tabs = /*#__PURE__*/function (_RefElementCollection) {
  ...
  return _createClass(Tabs, [{
    ...
    value: function createTabItem(text) {
      ...
      return {
        text: text,
        selected: (0,_ref_js__WEBPACK_IMPORTED_MODULE_2__.ref)(selected)
      };
    }
    ...
    value: function createTabItems() {
      ...
      return _ref_js__WEBPACK_IMPORTED_MODULE_2__.refArray.apply(void 0, _toConsumableArray(textList.map(function (t) {
        return Tabs.createTabItem(t);
      })));
    }
  }]);
}(_element_js__WEBPACK_IMPORTED_MODULE_0__.RefElementCollection);
    ...
    return _callSuper(this, TitleTabs, [_objectSpread(_objectSpread({}, props), {}, {
      toElement: function toElement(item) {
        ...
        text.checkRef(item.selected, function (selected) {
          text.style({
            color: selected ? _style_js__WEBPACK_IMPORTED_MODULE_1__.Color.TextColor : _style_js__WEBPACK_IMPORTED_MODULE_1__.Color.DescriptionColor,
    ...
    return _callSuper(this, UnderlineTabs, [_objectSpread(_objectSpread({}, props), {}, {
      toElement: function toElement(item) {
        ...
        var underline = new HorizontalDivider({
          styles: {
            height: '2px',
            backgroundColor: _style_js__WEBPACK_IMPORTED_MODULE_1__.Color.BgColor,
            margin: '0px 6px'
          }
        });
        column.add(text);
        ...
        column.checkRef(item.selected, function (selected) {
          ...
          underline.style({
            backgroundColor: selected ? _style_js__WEBPACK_IMPORTED_MODULE_1__.Color.TextColor : _style_js__WEBPACK_IMPORTED_MODULE_1__.Color.BgColor
          });
        });
        return column;
      }
...
var State = /*#__PURE__*/function (_Element10) {
  ...
  function State(props) {
    ...
    _this9 = _callSuper(this, State, [_objectSpread({
      tag: 'div'
    }, props)]);
    _this9.child = undefined;
    return _this9;
  }
...
var StateSet = /*#__PURE__*/function (_State) {
  ...
  function StateSet(props) {
    ...
    _this10 = _callSuper(this, StateSet, [_objectSpread({
      tag: 'div'
    }, props)]);
    _this10.states = props.states;
    _this10.checkRef(props.selectedItem, function (key) {
      _this10.el = _this10.states[key];
    });
    return _this10;
  }
...
var Route = /*#__PURE__*/function (_Element11) {
  ...
  function Route(props) {
    ...
    _this11._id = (_props$id = props === null || props === void 0 ? void 0 : props.id) !== null && _props$id !== void 0 ? _props$id : 'route';
    _this11.style(props === null || props === void 0 ? void 0 : props.styles);
    _this11.add(props === null || props === void 0 ? void 0 : props.el);
    _this11.id = (0,_element_js__WEBPACK_IMPORTED_MODULE_0__.createTagName)(_this11._id || 'route');
    return _this11;
  }
...
var Screen = /*#__PURE__*/function (_Route) {
  ...
  function Screen(props) {
    ...
    _this12 = _callSuper(this, Screen, [{
...
var Popup = /*#__PURE__*/function (_Route2) {
  ...
  function Popup(props) {
    ...
    _this13 = _callSuper(this, Popup, [{
      id: 'popup',
      attrs: {
        onclick: function onclick(e) {
          if (e.target == _this13.node && props.cancelOnClickOutside) {
            _this13.dismiss();
          }
        }
      }
    }]);
    _this13.popupContent = new _element_js__WEBPACK_IMPORTED_MODULE_0__.Element({
      tag: 'div',
      styles: {
        backgroundColor: _style_js__WEBPACK_IMPORTED_MODULE_1__.Color.BgColor
      }
    });
    _this13.add(_this13.popupContent);
    _this13.popupContent.add(props === null || props === void 0 ? void 0 : props.el);
    return _this13;
  }
...
var MenuPopup = /*#__PURE__*/function (_Popup) {
  ...
  function MenuPopup(props) {
    ...
    _this14 = _callSuper(this, MenuPopup, [{
      cancelOnClickOutside: true
    }]);
    _this14.popupContent.style(_objectSpread({
      width: 'auto',
      padding: '4px',
      position: 'absolute',
      borderRadius: '6px',
    ...
    }, _style_js__WEBPACK_IMPORTED_MODULE_1__.Style.Border));
...
var Dialog = /*#__PURE__*/function (_Popup2) {
  ...
  function Dialog(props) {
    ...
    _this15 = _callSuper(this, Dialog, [{
      styles: {
        backgroundColor: '#55555555'
      }
    }]);
    _this15.popupContent.style({
      width: '300px',
      padding: '16px',
      margin: 'auto'
    });
...
/* harmony export */ });
/* harmony import */ var _ref__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./ref */ "./src/ref.js");
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
function _createForOfIteratorHelper(r, e) { var t = "undefined" != typeof Symbol && r[Symbol.iterator] || r["@@iterator"]; if (!t) { if (Array.isArray(r) || (t = _unsupportedIterableToArray(r)) || e && r && "number" == typeof r.length) { t && (r = t); var _n = 0, F = function F() {}; return { s: F, n: function n() { return _n >= r.length ? { done: !0 } : { done: !1, value: r[_n++] }; }, e: function e(r) { throw r; }, f: F }; } throw new TypeError("Invalid attempt to iterate non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); } var o, a = !0, u = !1; return { s: function s() { t = t.call(r); }, n: function n() { var r = t.next(); return a = r.done, r; }, e: function e(r) { u = !0, o = r; }, f: function f() { try { a || null == t["return"] || t["return"](); } finally { if (u) throw o; } } }; }
function _callSuper(t, o, e) { return o = _getPrototypeOf(o), _possibleConstructorReturn(t, _isNativeReflectConstruct() ? Reflect.construct(o, e || [], _getPrototypeOf(t).constructor) : o.apply(t, e)); }
function _possibleConstructorReturn(t, e) { if (e && ("object" == _typeof(e) || "function" == typeof e)) return e; if (void 0 !== e) throw new TypeError("Derived constructors may only return object or undefined"); return _assertThisInitialized(t); }
...
var Element = /*#__PURE__*/function () {
  ...
  function Element(props) {
    ...
    this.attr(props === null || props === void 0 ? void 0 : props.attrs);
...
var ElementCollection = /*#__PURE__*/function (_Element) {
  /**
   * 
  ...
  _inherits(ElementCollection, _Element);
...
var RefElementCollection = /*#__PURE__*/function (_Element2) {
  /**
   * 
  ...
  _inherits(RefElementCollection, _Element2);
